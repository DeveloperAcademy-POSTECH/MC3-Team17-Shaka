...
class ExtensionDelegate: NSObject, WKExtensionDelegate {
    ...
    func applicationDidBecomeActive() {
        ...
        guard let start = UserDefaults.standard.object(forKey: "deactiveStartedStamp") as? Date else { return }
        let interval = Int(Date().timeIntervalSince(start))
        Foundation.NotificationCenter.default.post(name: NSNotification.Name("applicationDidBecomeActive"), object: nil, userInfo: ["time": interval])
    }
    }
